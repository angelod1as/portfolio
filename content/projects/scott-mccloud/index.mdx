...
<Audio
  src="scott-mccloud/scott-1.mp3"
  label="Why a sculptor and not a comic artist?"
/>

<Audio
  src="scott-mccloud/scott-2.mp3"
  label="How does sculpture behave in the frames of a comic?"
/>

<Audio
  src="scott-mccloud/scott-3.mp3"
  label="Do you consider yourself an academic?"
/>

<Audio
  src="scott-mccloud/scott-4.mp3"
  label='Why the choice of just three colors in "the sculptor"?'
/>
...
![Página da HQ de Scott McCloud](./cidade.webp)
