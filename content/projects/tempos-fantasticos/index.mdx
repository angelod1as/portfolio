...
description: A satirical sci-fi newspaper about alternative pasts, presents and futures
type: personal
year:
  from: 2016
  to: 2019
...
It has been a _wild ride_; our format has changed from a **double-sided black-and-white A3 sheet of paper** to a **full-fledged 4-color 8-pages newspaper**. The first edition had material only from myself, the last ones had collaborations from prominent brazilian writers.

From this (3rd edition):

![TF 3rd edition](./tf-cover-3.webp)

To this (25th edition):

![TF 25th edition](./tf-25-central.webp)

## Promo, fairs and events

I wrote, recorded and hosted the promotional videos for the newspaper's editions, and
took Tempos Fantásticos to comics fairs and independent publishing events — selling
issues, talking to readers, and explaining to a lot of confused people why a newspaper
was reporting on the future.

<YouTube id="VLWrmqSok8A" />

<YouTube id="deyWJ6Kzr2Y" />

<YouTube id="C-INPxOb9wA" />
