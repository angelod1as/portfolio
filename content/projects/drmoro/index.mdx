...
![A drawing of a ship in the sea with some rocks on the foreground](./drmoro-barco.webp)
...
![A table for creature-creation](./drmoro-tabela.webp)
...
![The map of the Dotô Morô island](./drmoro-mapa.webp)
...
![A drawing of a three-eyed monster cooking meat in a fire](./drmoro-monstro.webp)
