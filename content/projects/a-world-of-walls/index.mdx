...
medium:
  - web
how:
  - Good and old Javascript, HTML & CSS
...
Turn off adblockers otherwise the site won't load. Folha's issues.

With heavy focus on photography and video documentaries, 'A World of Walls' is an award-winning feature from Folha de S.Paulo. From its summary:
...
![Infographics example from A World of Walls feature](./summary-coding-walls-1.webp)

![Infographics example from A World of Walls feature](./summary-coding-walls-2.webp)

![Infographics example from A World of Walls feature](./summary-coding-walls-3.webp)
...
Read more about the technical issues found in Folha's special features reporting in the [Climate Crisis](/projects/climate-crisis) project.
