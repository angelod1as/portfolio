---
title: Recibo
description: A box that prints poems, comics, short stories, and children's activities
type: personal
year:
  from: 2021
  to: 2021
...
![A picture of Recibo box, with four coloured buttons and a poem being printed.](./recibo2.webp)
...
(If you know a way to run the script ONLY after the USB drives were mounted successfully, please let me know. All my attempts failed)
