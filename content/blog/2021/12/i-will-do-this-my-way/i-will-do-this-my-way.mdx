...
So, I built a six-color palette that rotates throughout the website. There are some pages that have pre-selected colors (like the [podcast link](/cronofobia-podcast)), while others (like this post) have a semi-random color selection.
