...
![Screenshot of my old portfolio with a Mosaic-like view](./mosaic.png "So many colors!")
...
When I designed the website, I thought about writing every step of the process of each project, from start to finish, to give my ~~future employers~~ beautiful readers the context needed.
...
So, I built a six-color palette that rotates throughout the website. There are some pages that have pre-selected colors (like the [podcast link](/projects/cronofobia-podcast)), while others (like this post) have a semi-random color selection.
