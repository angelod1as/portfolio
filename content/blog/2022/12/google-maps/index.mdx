...
date: 2022-12-13
description: implement Google Maps with a handy library brought by Google to make our lives easier!
categories:
  - tech
---
...
The `render` function is simple and practical: we can render different components depending on the status of the script loading.
...
You have a fully working map in your app, with the correct behavior of any Google Map instances you see around there.
...
![Screenshot from Google Maps](./google5.png)
