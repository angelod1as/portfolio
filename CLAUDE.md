...
The site is English and does not model language: no `lang` field, no badge, no filter, no
per-language routes. Older Portuguese entries publish unlabelled. Adding language handling
back is a decision and halts.
